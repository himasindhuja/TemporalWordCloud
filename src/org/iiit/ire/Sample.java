...
public class Sample implements Serializable {
	...
	private static Logger logger = MalletLogger.getLogger(Sample.class.getName());
	...
	public Sample (int numberOfTopics) {
		this (numberOfTopics, numberOfTopics, DEFAULT_BETA);
	}
	
	public Sample (int numberOfTopics, double alphaSum, double beta) {
	...
	public Sample (int numberOfTopics, double alphaSum, double beta, Randoms random) {
		this (newLabelAlphabet (numberOfTopics), alphaSum, beta, random);
	}
	
	public Sample (LabelAlphabet topicAlphabet, double alphaSum, double beta, Randoms random)
	{
	...
	protected void sampleTopicsForOneDoc (FeatureSequence tokenSequence,
		...
		for (int position = 0; position < docLength; position++) {
			...
			if (newTopic == -1) {
				throw new IllegalStateException ("Sample: New topic not sampled.");
			}
	...
	public static void main (String[] args) throws IOException {
		...
		Sample lda = new Sample (numTopics, 50.0, 0.01);
